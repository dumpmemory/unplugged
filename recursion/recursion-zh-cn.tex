...
\hline
边长 & $a$ & $\dfrac{a}{3}$ & $\dfrac{a}{9}$ & $\dots$ & $\dfrac{a}{3^n}$ $\dots$ \\
\hline
...
\[
\begin{array}{cll}
  & s + \dfrac{s}{3} + \dfrac{4s}{27} + \dots + \dfrac{3s}{4} (\dfrac{4}{9})^n + \dots & \\
= & s + \dfrac{3s}{4}\dfrac{4}{9} + \dfrac{3s}{4}(\dfrac{4}{9})^2 + \dots + \dfrac{3s}{4} (\dfrac{4}{9})^n + \dots & \text{除第一项外为等比数列，公比} \dfrac{4}{9} \\
= & \dfrac{s}{4} + \dfrac{3s}{4}\dfrac{1}{1-\dfrac{4}{9}} & \text{将第一项$s$变为}\dfrac{s}{4} + \dfrac{3s}{4} \\
= & \dfrac{8s}{5} & \\
\end{array}
\]
